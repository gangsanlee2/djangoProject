...
from basic.nlp.samsung_report.models import Entity
...
class Controller:
    ...
    def data_analysis(self):
        ...
        self.entity.fname = '/data/kr-Report_2018.txt'
        self.entity.context = dir_path('samsung_report')
    ...
    def hook(self):
        ...
        self.service.conversion_token()
        self.service.compound_noun()
        self.entity.fname = '/data/stopwords.txt'
        self.service.extract_stopword(self.entity)
        self.service.filtering_text_with_stopword()
