...
from basic.webcrawler.common import Common
from basic.webcrawler.scrapper import BugsMusic, MelonMusic, Scrap
...
class ScrapVO:
    ...
    def dataframe_to_csv(self):
        path = os.path.join(dir_path('webcrawler'), 'save', 'melon_rank.csv')
