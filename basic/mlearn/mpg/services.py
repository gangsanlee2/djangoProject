...
class Mpg:
    mpg = pd.read_csv(os.path.join(dir_path('mpg'), 'data', 'mpg.csv'))
    def __init__(self):
        self.mpg = pd.read_csv(os.path.join(dir_path('mpg'), 'data', 'mpg.csv'))
    def menu_1(self):
        print(self.mpg.head())
    ...
    def menu_10(self):
        ...
        plt.savefig(os.path.join(dir_path('mpg'), 'save', 'mpg_graph.jpg'))
