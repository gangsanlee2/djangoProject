...
class FruitsModel():
    def __init__(self):
        ...
        savepath = os.path.join(dir_path('fruits'), 'save')
        trainpath = os.path.join(dir_path('fruits'), 'fruits-360-5', 'Training')
        testpath = os.path.join(dir_path('fruits'), 'fruits-360-5', 'Test')
        batch_size = 32
        img_height = 100
        img_width = 100
